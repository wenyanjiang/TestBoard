...
#define USBD_PRODUCT_HS_STRING          "OXi Technology"			//STM32 USB CDC in HS mode
#define USBD_PRODUCT_FS_STRING          "OXi Technology"
...
uint8_t *  USBD_USR_SerialStrDescriptor( uint8_t speed , uint16_t *length)
{
  *length = USB_SIZ_STRING_SERIAL;
  ...
  Get_SerialNum();					//默认USB设备名称 STM32 USB CDC in HS mode

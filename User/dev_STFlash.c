...
static u32 sDev_STFlash_getSector(u32 flashAddress)
{
	u32 u32sector = 0;
...
bool Dev_STFlash_eraseSector(u32 flashAddress, u32 dataLength)
{
	...
	u32 u32startSector,u32endSector, u32sectorError;
...
bool Dev_STFlash_setAppInfo(u32 flashAddr, u32 appInfo)
{
	...
	memcpy(pu8tmpBuf, (u8* )(flashAddr&0xFFFFF000), 16*1024);
...
uint32_t Dev_STFlash_readWord(u32 addr)
{
	return *(uint32_t *)addr;
}

uint8_t Dev_STFlash_readByte(u32 addr)
{
	return *(uint8_t*)addr;
}

...
EN_RESP_TYPE prtcl_rcvPackParsing(ST_PRTCL_INFO* pstRcvInfo, u8* RcvBuf)
{
...
/**
  ...
  */
void prtcl_hostCmdPreproc(ST_PRTCL_INFO* pstCmdInfo, u16 plfmType, u8 prjType, u8 subprjType,
								EN_PACK_ID packID, u8 command, u16 paraLen, u8* paraBuf )
{
...
{
	memcpy((u8* )pstRespInfo, (u8* )pstRcvInfo, 4);/*merge protocol header*/
